...
// let tokenAngle = tokenData.rotation * 100; wieso gaht da nod
const myBiomes = [
...
function listenToTokens() {
  ...
  console.log("rotation value first :", tokenAngle);
}
